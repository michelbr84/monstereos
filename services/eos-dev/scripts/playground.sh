...
cleos -u http://localhost:8888 push action monstereosio battlejoin '[ "monsterusera", "monsterusere", "1342c65d924cd4839c776d6f7f7a7c575ad24cde49c347cb14ff359be52e9629" ]' -p monsterusere


# picks for secret:
# "secret":"1342c65d924cd4839c776d6f7f7a7c575ad24cde49c347cb14ff359be52e9629"}
cleos -u http://localhost:8888 push action monstereosio battlestart '{ "host": "monsterusera", "player": "monsterusere", "picks": {"pets": [14], "randoms": [169, 147, 130, 65, 251, 7, 209, 45, 56, 104, 151, 118, 32, 172, 43, 25, 95, 79, 190, 97, 66, 94, 192, 160, 4, 180, 1, 20, 94, 94, 187, 58]} }' -p monsterusere

cleos push action monstereosio battleattack '[ "monsterusera", "monsterusere", 14, 13, 0 ]' -p monsterusere


cleos -u http://localhost:8888 push action monstereosio battleleave '[ "monsterusera", "monsterusera" ]' -p monsterusera


cleos -u http://localhost:8888 push action monstereosio battlefinish '{ "host": "raul", "winner": "" }' -p monstereosio
...
cleos -u http://localhost:8888 push action monstereosio migrate '["delete old arenas"]' -p monstereosio
...
cleos -u http://localhost:8888 set contract monstereosmt ../market
cleos -u http://localhost:8888 push action eosio.token transfer '["monsterusera", "monstereosio", "1.0000 EOS", "MTT3"]' -p monsterusera

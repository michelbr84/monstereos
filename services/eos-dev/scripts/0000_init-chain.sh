...
sleep .5
cleos -u http://localhost:8888 create account eosio eosio.bpay $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos -u http://localhost:8888 create account eosio eosio.msig $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.names $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.ram $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.ramfee $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.saving $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.stake $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.token $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY
sleep .5
cleos  -u http://localhost:8888 create account eosio eosio.vpay $EOSIO_SYS_PUBKEY $EOSIO_SYS_PUBKEY

# deploy system account contracts
sleep .5
cleos -u http://localhost:8888 set contract eosio.token /eosio.contracts/build/contracts/eosio.token
sleep .5
cleos -u http://localhost:8888 set contract eosio.msig /eosio.contracts/build/contracts/eosio.msig

# issue tokens
sleep .5
cleos -u http://localhost:8888 push action eosio.token create '["eosio", "10000000000.0000 SYS"]' -p eosio.token
sleep .5
cleos -u http://localhost:8888 push action eosio.token issue '["eosio", "100000000.0000 SYS", "memo"]' -p eosio
sleep .5
cleos -u http://localhost:8888 push action eosio.token create '["eosio", "10000000000.0000 EOS"]' -p eosio.token
sleep .5
cleos -u http://localhost:8888 push action eosio.token issue '["eosio", "100000000.0000 EOS", "memo"]' -p eosio

# deploy the system contract
sleep 2s
# cleos -u http://localhost:8888 set contract eosio /eosio.contracts/build/contracts/eosio.system

# Create the monstereosio account
sleep 2s
echo "Creating MonsterEOS account"
cleos -u http://localhost:8888 create account eosio monstereosio $MONSTERS_ACCOUNT_PUBLIC_OWNER_KEY $MONSTERS_ACCOUNT_PUBLIC_ACTIVE_KEY
sleep .5
cleos -u http://localhost:8888 transfer eosio monstereosio "1000000.0000 SYS"
cleos -u http://localhost:8888 transfer eosio monstereosio "1000000.0000 EOS"
...
cleos -u http://localhost:8888 set contract monstereosio "$CONTRACTS_DIR"/monstereosio

sleep .5
echo "Creating players"
cleos -u http://localhost:8888 create account eosio $MONSTERS_USERA_ACCOUNT $MONSTERS_USERA_PUBKEY $MONSTERS_USERA_PUBKEY
sleep .5
cleos -u http://localhost:8888 create account eosio $MONSTERS_USERB_ACCOUNT $MONSTERS_USERB_PUBKEY $MONSTERS_USERB_PUBKEY
sleep .5
cleos -u http://localhost:8888 create account eosio $MONSTERS_USERC_ACCOUNT $MONSTERS_USERC_PUBKEY $MONSTERS_USERC_PUBKEY
sleep .5
cleos -u http://localhost:8888 create account eosio $MONSTERS_USERD_ACCOUNT $MONSTERS_USERD_PUBKEY $MONSTERS_USERD_PUBKEY
sleep .5
cleos -u http://localhost:8888 create account eosio $MONSTERS_USERE_ACCOUNT $MONSTERS_USERE_PUBKEY $MONSTERS_USERE_PUBKEY

echo "Waiting for node boostraping to complete"
sleep 2s

echo "Change tolerance to 0 for testing purposes"
cleos -u http://localhost:8888 push action monstereosio changecrtol '{ "new_interval": 0 }' -p monstereosio
